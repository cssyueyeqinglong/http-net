...
public class BaseAdapterHelper {
     ...
     * @return
     */
    public BaseAdapterHelper setCircleImageView(int viewId, String value,int id) {
        ImageView view = retrieveView(viewId);
//        BitmapManager.displayCircleImageView(view, value, id);
        return this;
    }
     ...
     * @return
     */
    public BaseAdapterHelper setImageByUrl(int viewId, String url) {
//        BitmapManager.displayImageView((ImageView) getView(viewId),url);
      // ImageLoader.getInstance(5, Type.FIFO).loadImage(url, (ImageView) getView(viewId), 0);
        // BmUtils.display((ImageView) getView(viewId), url,
    ...
    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl, int failedResId) {
        ImageView view = retrieveView(viewId);
//        BitmapManager.displayImageView(view, imageUrl, failedResId);
    ...
    public BaseAdapterHelper setRoundedImageUrl(int viewId, String imageUrl,
                                                int failedResId) {
        ImageView view = retrieveView(viewId);
//        BitmapManager.displayCircleImageView(view, imageUrl, failedResId);
        return this;
    }

    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl) {
        ImageView view = retrieveView(viewId);
//        BitmapManager.displayImageView(view, imageUrl);
        // BmUtils.display(view, imageUrl, R.drawable.white);
        return this;
    }
