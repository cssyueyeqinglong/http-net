...
import static cn.carhouse.scdemo.base.BaseAdapterHelper.get;
...
public abstract class QuickAdapter<T> extends
	...
	public QuickAdapter(Context context, int layoutResId, List<T> data,boolean flag) {
		super(context, layoutResId, data,flag);
	}
